...
//    ins->setRegistrationId(r);
    ins->metaObject()->invokeMethod(ins, "setUserId", Q_ARG(QString, u));
    ins->metaObject()->invokeMethod(ins, "setRegistrationId", Q_ARG(QString, r));
}
