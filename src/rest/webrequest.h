...
class WebRequest : public QObject
{
    ...
    Q_PROPERTY(bool alwaysEmitFinished READ alwaysEmitFinished WRITE setAlwaysEmitFinished NOTIFY alwaysEmitFinishedChanged)
...
signals:
    ...
    void alwaysEmitFinishedChanged(bool alwaysEmitFinished);
...
public slots:
    ...
    void setAlwaysEmitFinished(bool alwaysEmitFinished);
};
