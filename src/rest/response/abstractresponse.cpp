...
void AbstractResponse::processReply(const QByteArray &buffer)
{

}

void AbstractResponse::processReply(QNetworkReply *reply)
{
...
bool AbstractResponse::selfProcess()
{
    return false;
}

bool AbstractResponse::hasHeader(const QString &headerName) const
{
