...
#include "response/filedownload.h"
...
void KajRestModule::registerTypes()
{
    ...
    qmlRegisterType<Header>(KAJ_PACKAGE_NAME, KAJ_VERSION_MAJOR, KAJ_VERSION_MINOR, "Header");
    qmlRegisterType<FileItem>(KAJ_PACKAGE_NAME, KAJ_VERSION_MAJOR, KAJ_VERSION_MINOR, "FileItem");
//    qmlRegisterType<FormData>(KAJ_PACKAGE_NAME, KAJ_VERSION_MAJOR, KAJ_VERSION_MINOR, "FormData");
    ...
    qmlRegisterUncreatableType<AbstractHelper>(KAJ_PACKAGE_NAME, KAJ_VERSION_MAJOR, KAJ_VERSION_MINOR, "AbstractHelper", "Abstract class");
    ...
    qmlRegisterType<FileDownload>(KAJ_PACKAGE_NAME, KAJ_VERSION_MAJOR, KAJ_VERSION_MINOR, "FileDownload");
